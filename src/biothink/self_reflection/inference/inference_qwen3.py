"""Model Inference Pipeline with original Qwen3 model.

This script performs batch inference using a Qwen3 model for biomedical question answering.
...
if __name__ == "__main__":
    ...
    output_file = "generations_qwen3_1.7b.jsonl"
